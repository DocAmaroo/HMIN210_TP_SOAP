...
namespace HotelServices
{
    ...
    public class Formule1Services : System.Web.Services.WebService
    {
        ...
        {
            Client client = new Client("Dupont", "Dupont", "69420");
            ...
            hotel = new Hotel("Formule1 Hotel", "France", "Montpellier", "420 rue des oliviers", "", "49.726x3.648", 5, chambres, agencesPartenaire);
        }
    }
}
